...
public class Update extends MenuInterface{
	...
	public void executeAction() {
		...
		this.ihmUtil.getPizzaDao().updatePizza(this.ihmUtil.getPizzaDao().findAll().get(choix).getId(), new Pizza(this.ihmUtil.getPizzaDao().findAll().get(choix).getId(), codePizza, nomPizza, prixPizza));
	}
