...
public class PizzeriaAdminConsoleApp {
	...
	private static void delete(Pizza[] tableauPizza2) {
		...
		do{
			...
			System.out.println(" \n Veuillez choisir une pizza dans la liste � supprimer ou entrez 99 pour quitter");
	...
	private static void update(Pizza[] tableauPizza2) {
		...
		do{
			...
			System.out.println(" \n Veuillez choisir une pizza dans la liste � modifier ou entrez 99 pour quitter");
	...
	private static void liste(Pizza[] tableauPizza2) {
		...
		System.out.println("-----------" + Pizza.nbPizzas + " pizzas cr�e depuis l'initialisation du prog");
	}
